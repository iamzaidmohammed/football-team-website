...
$stmt = $db_connection->prepare("SELECT id, match_date, home_team_logo, home_team_name, away_team_logo, away_team_name, match_time, status, home_team_score, away_team_score FROM matches");
